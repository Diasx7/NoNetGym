...
async function renderizarUltimoRegistro() {
  ...
  const campos = {
    weight: 'Peso', waist: 'Cintura', abdomen: 'Abdômen',
    chest: 'Peito', arm: 'Braço', leg: 'Perna'
  }
...
// grafico com varias medidas junto — usado na pagina de progresso
